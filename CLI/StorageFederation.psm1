...
#>
[CmdletBinding()]
param(	[Parameter(Position=1)][Switch]			$Force,
		[Parameter(Position=1)][System.String]	$UUID ,
		[Parameter(Position=2)][System.String]	$FedName ,
		[Parameter(Position=3)][System.String]	$Comment ,
		[Parameter(Position=4)][System.String]	$Setkv ,
		[Parameter(Position=5)][System.String]	$Setkvifnotset ,
		[Parameter(Position=6, ValueFromPipeline=$true)]			$SANConnection = $global:SANConnection        
	)		
Process	
...
#>
[CmdletBinding()]
param(	[Parameter(Position=0)][System.String]	$Fedname ,
		[Parameter(Position=1)][System.String]	$Comment ,
		[Parameter(Position=2)][System.String]	$Setkv ,
		[Parameter(Position=3)][System.String]	$Setkvifnotset ,
		[Parameter(Position=4, ValueFromPipeline=$true)]	$SANConnection = $global:SANConnection        
	)		
Process	
...
#>
[CmdletBinding()]
param(	[Parameter(Position=1)][System.String]			$FedName ,
		[Parameter(Position=2)][System.String]			$Comment ,
		[Parameter(Position=3)][System.String]			$Setkv ,	
		[Parameter(Position=4)][System.String]			$Setkvifnotset ,
		[Parameter(Position=5)][switch]					$ClrAllKeys ,
		[Parameter(Position=6)][System.String]			$ClrKey ,
		[Parameter(Position=7)][System.String]			$ClrKV ,
		[Parameter(Position=8)][System.String]			$IfKV ,
		[Parameter(Position=9, ValueFromPipeline=$true)]$SANConnection = $global:SANConnection        
	)		
Process
...
#>
[CmdletBinding()]
param(	[Parameter(Position=0, ValueFromPipeline=$true)]	$SANConnection = $global:SANConnection        
	)		
Process	
