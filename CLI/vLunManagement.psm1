...
param(	[Parameter(Position=0, Mandatory=$false)]
		[System.String]	$vvName,
		
		[Parameter(Position=1, Mandatory=$false, ValueFromPipeline=$true)]
		[System.String]	$PresentTo, 	
...
#>
[CmdletBinding()]
param(	[Parameter(Position=0)]	[System.String]		$vvName,
		
		[Parameter(Position=1)]	[System.String]		$vvSet,
		
		[Parameter(Position=2)]	[System.String]		$LUN,
		
		[Parameter(Position=3)]	[System.String]		$NSP,
		
		[Parameter(Position=4)]	[System.String]		$HostSet,
		
		[Parameter(Position=5)]	[System.String]		$HostName,
		
		[Parameter(Position=6)]	[System.String]		$Cnt,
		
		[Parameter(Position=7)]	[switch]			$NoVcn,
		
		[Parameter(Position=8)]	[switch]			$Ovrd,
...
#>
[CmdletBinding()]
param(	[Parameter(Position=0, ValueFromPipeline=$true)][Switch]		$force, 
		[Parameter(Position=1, ValueFromPipeline=$true)][Switch]		$whatif, 		
		[Parameter(Position=2, ValueFromPipeline=$true)][System.String]	$vvName,
		[Parameter(Position=3, ValueFromPipeline=$true)][System.String]	$PresentTo, 		
		[Parameter(Position=4, ValueFromPipeline=$true)][Switch]		$Novcn,
		[Parameter(Position=5, ValueFromPipeline=$true)][Switch]		$Pat,
		[Parameter(Position=6, ValueFromPipeline=$true)][Switch]		$Remove_All,
		[Parameter(Position=7, ValueFromPipeline=$true)]				$SANConnection = $global:SANConnection        
	)		
Process	
